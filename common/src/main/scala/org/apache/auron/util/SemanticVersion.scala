...
case class SemanticVersion(majorVersion: Int, minorVersion: Int)
  ...
  /**
   * Returning a double in format of "majorVersion.minorVersion". Note: Not suitable for version
   * comparison, only for logging.
   * @return
   */
    ...
    semanticVersionRegex.findFirstMatchIn(versionString) match {
      ...
      case None =>
        throw new IllegalArgumentException(
          s"Tried to parse '$versionString' as a project" +
